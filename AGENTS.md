...
- `StageProgressServiceTests` contains ten EditMode tests covering stage state, progress-aware routing, statuses, replay completion events, and one-shot full-game completion.
